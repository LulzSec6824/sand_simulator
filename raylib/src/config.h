...
// (SetShaderValueTexture()) #define RL_MAX_MATRIX_STACK_SIZE              32      // Maximum size of internal Matrix stack #define
// RL_MAX_SHADER_LOCATIONS               32      // Maximum number of shader locations supported #define RL_CULL_DISTANCE_NEAR                  0.05
// // Default projection matrix near cull distance #define RL_CULL_DISTANCE_FAR                4000.0    // Default projection matrix far cull
// distance
...
// location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_TEXCOORD #define RL_DEFAULT_SHADER_ATTRIB_NAME_NORMAL         "vertexNormal"       // Bound by default
// to shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_NORMAL #define RL_DEFAULT_SHADER_ATTRIB_NAME_COLOR          "vertexColor"        // Bound by
// default to shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_COLOR #define RL_DEFAULT_SHADER_ATTRIB_NAME_TANGENT        "vertexTangent"      //
// Bound by default to shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_TANGENT #define RL_DEFAULT_SHADER_ATTRIB_NAME_TEXCOORD2 "vertexTexCoord2" //
...
// RL_DEFAULT_SHADER_ATTRIB_LOCATION_BONEWEIGHTS #define RL_DEFAULT_SHADER_ATTRIB_NAME_INSTANCETRANSFORM "instanceTransform" // Bound by default to
// shader location: RL_DEFAULT_SHADER_ATTRIB_LOCATION_INSTANCETRANSFORM #define RL_DEFAULT_SHADER_UNIFORM_NAME_MVP           "mvp"                //
// model-view-projection matrix #define RL_DEFAULT_SHADER_UNIFORM_NAME_VIEW          "matView"            // view matrix #define
// RL_DEFAULT_SHADER_UNIFORM_NAME_PROJECTION    "matProjection"      // projection matrix #define RL_DEFAULT_SHADER_UNIFORM_NAME_MODEL "matModel" //
// model matrix #define RL_DEFAULT_SHADER_UNIFORM_NAME_NORMAL        "matNormal"          // normal matrix (transpose(inverse(matModelView)) #define
// RL_DEFAULT_SHADER_UNIFORM_NAME_COLOR         "colDiffuse"         // color diffuse (tint color, multiplied by texture color) #define
